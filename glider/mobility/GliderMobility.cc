...
#include "environment/WindManager.h"
...
double GliderMobility::climb(double airflow, double turn)
{
...
double GliderMobility::getCourse(void)
{
	Coord dir = move.getDirection();
	return fmod((atan2(dir.y, dir.x) * 180.0 / PI) + 90, 360);
}

double GliderMobility::getPlaygroundArea()
{
