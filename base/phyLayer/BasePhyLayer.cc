...
void BasePhyLayer::handleChannelSenseRequest(cMessage* msg) {
	...
	{
		opp_error("Next handle time of ChannelSenseRequest returned by the Decider is smaller then current simulation time: %.2f", SIMTIME_DBL(nextHandleTime));
	}
